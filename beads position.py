...
folder = "E:\\Buffer exchange\\20200106\\P06\\"
ExpFolder = "E:\\Buffer exchange\\20200106\\P06\\"
window_size = 6
Sample = "20200106-BE-137-300530-T1-P06"
...
for i,name in enumerate(Rois):
    ...
    Bead_P = GetBeadsPosition(folder,Targetfile,window_size,bead_xy,ImageSave=True,Bead_label=name,TranFun=TranFun)#
...
'''Color control'''
#colmap = cm.brg(range(255))
#col_indices = np.floor(np.arange(0,Exp_step_N*2+1)*255.0/len(np.arange(0,Exp_step_N*2+1)))
...
#ax.scatter(Bead_P[:,0],Bead_P[:,1],marker='o',facecolors='none',edgecolors='r',s=2)
#ax.invert_yaxis()
#plt.show()
